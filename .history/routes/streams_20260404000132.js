 ...
 */
router.post("/test-auth", requirePermission('streams:view'), (req, res) => {
 ...
 */
router.put("/:name/rename", requirePermission('streams:rename'), async (req, res) => {
 ...
 */
router.post("/:name/start", requirePermission('streams:start'), (req, res) => {
 ...
 */
router.post("/youtube/:name", requirePermission('streams:create'), async (req, res) => {
 ...
 */
router.post("/:name/stop", requirePermission('streams:stop'), (req, res) => {
 ...
 */
router.delete("/:name", requirePermission('streams:delete'), (req, res) => {
  const name = req.params.name;
