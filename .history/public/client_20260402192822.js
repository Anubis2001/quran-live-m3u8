...
async function stopStream(name) { await fetch(`/api/streams/${name}/stop`, { method: "POST" }); refresh(); }
async function startStream(name) { await fetch(`/api/streams/${name}/start`, { method: "POST" }); refresh(); }
async function deleteStream(name) { await fetch(`/api/streams/${name}`, { method: "DELETE" }); refresh(); }
